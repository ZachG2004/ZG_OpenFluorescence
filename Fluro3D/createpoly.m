function createpoly(op,callback,h_figure,h_report,initvals)
%syntax:  createpoly(op,callback,h_figure,h_report,initvals)
%
   ...
   if strcmp(op,'init')
      ...
      if nargin >= 4
         ...
         uicontrol(h_dlg, ...
            ...
            'BackgroundColor',c, ...
            'Tag','togglenum', ...
            'Callback','createpoly(''tog_num'')');

         uicontrol(h_dlg, ...
            'Style','pushbutton', ...
            'Position',[0 0 .2 .2], ...
            'String','Cancel', ...
            'Callback','createpoly(''cancel'')');
      ...
      elseif strcmp(op,'eval')
         ...
         if strcmp(method,'graph')
            ...
            if ~isempty(polygon)
               polydata = [{polyname} {polystyle+1} {datestr(now,0)} {polygon}];
            ...
            polydata = [{polyname} {polystyle+1} {datestr(now,0)} {initpolygon}];
